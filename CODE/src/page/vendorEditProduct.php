...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            <!-- Navigation links -->
            <a href="../page/vendorPage.php">Home</a> <!-- Active link to home -->
            ...
            <div class="user-menu" id="userMenu">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    ...
                    <!-- Form for Logout -->
                    <form action="vendorEditProduct.php" method="GET">
    ...
    <div class="addProduct-container">
        ...
        <form id="addProduct-form" action="vendorEditProduct.php" method="POST" enctype="multipart/form-data" class="addProduct-form">
                ...
                <div class="form-group" id="uploadImageId">
                    ...
                    <div class="imageUpload-container" id="dropZone">
                        ...
                        <div>
                            ...
                            <input type="file" id="image" name="image" hidden accept="image/*" required> <!-- Image input -->
                        </div>
                    </div>
                </div>
                <div>
        ...
        <form action="vendorEditProduct.php" method="POST">
            <!-- Delete -->
            <?php echo '<input type="text" hidden name="id" value="'.$prodID.'">' ?>
