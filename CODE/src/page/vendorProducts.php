...
//shows all products for this specific vendor
$row = prodlist::vendorProd(0);
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $searchWord = $_POST["search"];
    if(!empty($searchWord)){
        $row = prodlist::vendorSearchProd($searchWord);
    } else {
        $row = prodlist::vendorProd(0, 'ASC');
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="../page/vendorProducts.php" id="active">Your Products</a>
            <div class="user-menu" id="userMenu">
                <button class="user-btn" id="userBtn">
                    <i class="fas fa-user"></i>
                </button>
                <div class="dropdown-menu" id="dropdownMenu">
                    <a href="vendorProfile.php" id="profileBtn">Profile</a>
                    <!-- Form for Logout -->
                    <form action="vendorProducts.php" method="GET">
    ...
    <header class="products-header">
        ...
        <div class="filters">
            ...
            <div class="search-bar">
                <form method="POST" action="vendorProducts.php">
    ...
    <section class="new-products">
        <h2>All of your listed Products</h2>
